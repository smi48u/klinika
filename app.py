...
MIN_SELLER_CREDIT = 2_200_000
MAX_SELLER_CREDIT = 3_000_000
NEUTRAL_SELLER_CREDIT = 2_200_000
...
def calculate_transaction(scenario: Scenario) -> dict[str, object]:
    ...
    property_and_equipment_value = total - seller_credit

    return {
        "base_value": BASE_VALUE,
        "total": total,
        "seller_credit": seller_credit,
        "property_and_equipment_value": property_and_equipment_value,
...
def calculate() -> tuple[object, int]:
    ...
    scenario = Scenario(
        ...
        seller_credit=int(payload.get("seller_credit", 2_200_000)),
